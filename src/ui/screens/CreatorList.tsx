...
const CreatorListScreen: React.FC<CreatorListScreenProps> = ({ configRepo }) => {
    ...
    if (creators.length === 0) {
        return (
            <Box padding={1}>
                <Text color="yellow">No creators registered. Run 'valiv add' to add one.</Text>
            </Box>
        );
    }
    ...
    return (
        <Box flexDirection="column" padding={1}>
            <Text bold underline>Registered Creators</Text>
